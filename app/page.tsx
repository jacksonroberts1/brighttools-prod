      ...
      <div className="relative z-10">
        ...
        <Section noPadding className="min-h-screen flex items-start justify-center">
          <div className="max-w-[1600px] mx-auto w-full px-4 pt-32 pb-24 text-center">
            ...
            <div className="mt-16 mb-8">
              <div className="mb-6">
                <div className="text-sm font-bold text-white/50 uppercase tracking-[0.3em] mb-2">Applied Framework</div>
                <div className="text-base font-semibold text-cyan-400/70 uppercase tracking-wide">Role • Format • Context • Logic</div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
                <div className="relative w-full flex flex-col items-center p-6">
                  <div className="text-3xl font-black text-white mb-8 tracking-widest h-[3rem] flex items-center justify-center">BEFORE</div>
                  <ChatTypingAnimation 
                ...
                <div className="relative w-full flex flex-col items-center p-6">
                  <div className="text-3xl font-black text-cyan-400 mb-8 tracking-widest h-[3rem] flex items-center justify-center drop-shadow-[0_0_20px_rgba(34,211,238,0.5)]">AFTER</div>
                  <ChatTypingAnimation 
            ...
            <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
              <div className="space-y-4">
                <div className="space-y-6">
                  <div>
                    <span className="text-xs uppercase tracking-wider text-white/40 font-semibold">Universal Skill</span>
                  </div>
                  ...
                  <p className="text-sm md:text-base text-white/50 leading-relaxed font-normal brand-body max-w-md">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="mb-8 space-y-4">
              <div className="space-y-3">
                <span className="text-xs uppercase tracking-wider text-white/40 font-semibold">Capabilities</span>
                ...
                <Card delay={0} className="group relative overflow-hidden h-full">
                  ...
                  <div className="relative h-full flex flex-col">
                    ...
                    <div className="flex items-start justify-between mb-8">
                      ...
                      <span className="text-xs uppercase tracking-widest text-white/50 font-black text-right leading-none pt-2">Professional Results</span>
                    </div>
                    {/* Enhanced heading with better visual hierarchy */}
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight brand-title">Prompt engineering frameworks</h3>
                ...
                <Card delay={0.1} className="group relative overflow-hidden h-full">
                  ...
                  <div className="relative h-full flex flex-col">
                    <div className="flex items-start justify-between mb-8">
                      ...
                      <span className="text-xs uppercase tracking-widest text-white/50 font-black text-right leading-none pt-2">Security + Consistency</span>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight brand-title">Human-in-the-loop method</h3>
                    <p className="text-lg text-white/60 leading-relaxed flex-1 font-normal brand-body">
                ...
                <Card delay={0.2} className="group relative overflow-hidden h-full">
                  ...
                  <div className="relative h-full flex flex-col">
                    <div className="flex items-start justify-between mb-8">
                      ...
                      <span className="text-xs uppercase tracking-widest text-white/50 font-black text-right leading-none pt-2">Workflow Integration</span>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight brand-title">Applied use</h3>
                    <p className="text-lg text-white/60 leading-relaxed flex-1 font-normal brand-body">
        ...
        <Section className="relative overflow-hidden -mt-12 md:-mt-20 pt-20 md:pt-28">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="space-y-4 mb-16">
              <div>
                <span className="text-xs uppercase tracking-wider text-white/40 font-semibold">The Difference</span>
        ...
        <Section className="relative overflow-hidden -mt-16 md:-mt-24 pt-24 md:pt-36">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="space-y-4 mb-16">
              <span className="text-xs uppercase tracking-wider text-white/40 font-semibold">Our Approach</span>
              {/* Massive display serif */}
              <h2 className="text-7xl md:text-8xl lg:text-9xl font-black text-white leading-[0.9] brand-title">
                How We Work
              </h2>
        ...
        <Section className="relative overflow-hidden -mt-20 md:-mt-32 pt-32 md:pt-44">
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="space-y-4 mb-20">
              <div className="flex-1">
                <span className="text-xs uppercase tracking-wider text-white/40 font-semibold">Testimonials</span>
                {/* Massive display serif */}
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="glass glass-hover rounded-2xl p-8 border border-white/10">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm mt-1">Founder, Philadelphia-based Insurance Company</div>
                </div>
              </div>
              ...
              <div className="glass glass-hover rounded-2xl p-8 border border-white/10">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm mt-1">CSO, Denver-based Marketing Agency</div>
                </div>
              </div>
              ...
              <div className="glass glass-hover rounded-2xl p-8 border border-white/10">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm mt-1">Founder, New York City-based Startup</div>
                </div>
              </div>
            </div>
          </div>
